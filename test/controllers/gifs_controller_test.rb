...
class GifsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gif" do
    assert_difference('Gif.count') do
      post gifs_url, params: { gif: { description: @gif.description, image: @gif.image, label: @gif.label } }
    end
  ...
  test "should update gif" do
    patch gif_url(@gif), params: { gif: { description: @gif.description, image: @gif.image, label: @gif.label } }
