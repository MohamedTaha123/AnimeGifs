...
/* This is the custom StimulusReflex controller for NotificationsReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="NotificationsReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "NotificationsReflex#example"
   *
